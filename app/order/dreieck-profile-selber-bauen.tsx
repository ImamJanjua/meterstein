...
const DreieckProfileSelberBauen = () => {
  ...
  // Color and profile type
  const [farbe, setFarbe] = React.useState("");
  const [rahmenprofil, setRahmenprofil] = React.useState(false);
  const [mittelprofil, setMittelprofil] = React.useState(false);
  ...
  const profilartOptions = [
    "Rahmenprofil AL8002 mit Deckel",
    "Mittelprofil AL8000 mit Deckel",
  ];
        ...
        <View className="gap-8 p-4 bg-background/30">
          ...
          <View className="gap-2">
            ...
            <CheckboxWithLabel
              ...
              onToggle={() => setRahmenprofil(!rahmenprofil)}
            />
            <CheckboxWithLabel
              label="Mittelprofil AL8000 mit Deckel"
              checked={mittelprofil}
              onToggle={() => setMittelprofil(!mittelprofil)}
            />
          </View>
...
export default DreieckProfileSelberBauen;
