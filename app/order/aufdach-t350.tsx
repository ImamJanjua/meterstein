  ...
  async function sendOrder() {
    ...
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/api/email`, {
        ...
        body: JSON.stringify({
          senderName: `${userName}`,
          type: 'Bestellung - Aufdach T350 ZIP',
          data: {
            Kundenname: nameKunde.trim(),
            "Maß a (Innenkante - Innenkante -60mm)": `${measurementA} mm`,
            "Maß b (Außenkante - Außenkante)": `${measurementB} mm`,
        ...
        <View className="gap-4 p-4 bg-background/30">
          ...
          <View className="gap-2">
            ...
            <Text className="text-muted-foreground">
              in mm Mitte Sparren - Mitte Sparren
            </Text>
          </View>
