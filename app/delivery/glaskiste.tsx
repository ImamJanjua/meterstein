      ...
      >
        <View className="gap-8 p-4 bg-background/30">
          <View className="mt-8 items-center">
            <Text className="text-3xl font-bold text-red-500">Glaskiste</Text>
          </View>
          ...
          >
            <Image
              source={require("~/assets/images/glaskiste.webp")}
              contentFit="contain"
          ...
          <View className="gap-2">
            ...
            <Text className="text-muted-foreground">Maße: 4020 x 1120 mm</Text>
            <Input
              value={stueck}
