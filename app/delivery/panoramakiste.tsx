    ...
    >
      ...
      >
        <View className="gap-8 p-4 bg-background/30">
          ...
          >
            <Image
              source={require("~/assets/images/panoramakiste.webp")}
              contentFit="contain"
          ...
          <View className="gap-2">
            ...
            <Text className="text-muted-foreground">Maße: 1120 x 2400 mm</Text>
            <Input
              value={stueck}
